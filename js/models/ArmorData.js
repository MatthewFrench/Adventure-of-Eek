const ARMOR_CARDBOARD_UNDERWEAR = {id:1, name: "Cardboard Underwear", rating: 1, cost: 25, buyLine: "Kinda chafey. At least they're already brown."};
const ARMOR_CROCHETED_CROCS = {id:2, name: "Crocheted Crocs", rating: 2, cost: 60, buyLine: "So breathable, so comfortable, so humiliating."};
const ARMOR_CARPET_TSHIRT = {id:3, name: "Carpet T-Shirt", rating: 3, cost: 140, buyLine: "Itchy, stiff, but it feels like the carpet at home."};
const ARMOR_WOOD_PANTS = {id:4, name: "Wood Pants", rating: 4, cost: 330, buyLine: "\"There's wood in your pants?\" No the pants are wood!"};
const ARMOR_SHINY_NIGHTGOWN = {id:5, name: "Shiny Nightgown", rating: 5, cost: 470, buyLine: "I look stunning. Super silky and breathable."};
const ARMOR_CHRISTMAS_LIGHT_UP_SOCKS = {id:6, name: "Christmas Light Up Socks", rating: 6, cost: 820, buyLine: "These are definitely dad socks. Even plays a Christmas tune."};
const ARMOR_ADAMANTIUM_NOSE_RING = {id:7, name: "Adamantium Nose-ring", rating: 8, cost: 1210, buyLine: "Wolverine would be so jealous. We're allowed to wear other armor with this, right?"};
